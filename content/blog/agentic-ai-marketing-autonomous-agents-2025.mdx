...
- Conversion rate target: greater than 3% (vs. current 2.1%)
- CAC target: less than $45 (vs. current $62)
- ROAS target: greater than 4:1 (vs. current 3.2:1)
...
- Human approval required for budget greater than $1,000/day
